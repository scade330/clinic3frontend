...
import {
  getAllPharmacies,
  deletePharmacy,
} from "../../lib/pharmacyApi"; // <-- use your API functions
...
export default function PharmacyList() {
  ...
  const closeEditDialog = () => setItemToEdit(null);
        ...
        <table className="w-full text-left border-separate border-spacing-0">
          <thead className="bg-blue-50 text-gray-600 uppercase text-sm sticky top-0 z-10 shadow-md">
            <tr>
              ...
              {headers.map((header) => (
                <th key={header} className="p-3 border-b border-gray-200">
                  {header}
                </th>
              ))}
          ...
          <tbody>
            {loading && (
              <tr>
                <td
                  className="p-5 text-center text-blue-500 font-medium"
                  colSpan={9}
                >
                  Loading inventory...
                </td>
            ...
            {!loading && filteredInventory.length === 0 && (
              <tr>
                <td className="p-5 text-center text-gray-500" colSpan={9}>
